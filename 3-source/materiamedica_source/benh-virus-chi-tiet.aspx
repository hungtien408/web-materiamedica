<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
    CodeFile="benh-virus-chi-tiet.aspx.cs" Inherits="tin_tuc_chi_tiet" %>
    ...
    <div class="container">
        <div class="wrapper-main">
            ...
            <asp:ObjectDataSource ID="odsNewDetails" runat="server" SelectMethod="ProductSelectOne"
                ...
                <SelectParameters>
                    <asp:QueryStringParameter Name="ProductID" QueryStringField="vt" Type="String" />
                </SelectParameters>
        ...
        <div class="more-news">
            ...
            <asp:ListView ID="lstNewSame" runat="server" DataSourceID="odsNewSame" EnableModelValidation="True">
                <ItemTemplate>
                    <li><a href='<%# progressTitle(Eval("ProductName")) + "-vt-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductName") %></a></li>
                </ItemTemplate>
                <LayoutTemplate>
                    <ul>
            ...
            <asp:ObjectDataSource ID="odsNewSame" runat="server" 
                ...
                <SelectParameters>
                    ...
                    <asp:QueryStringParameter DefaultValue="" Name="ProductID" 
                        QueryStringField="vt" Type="String" />
                </SelectParameters>
            </asp:ObjectDataSource>
        </div>
    </div>
