<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
    CodeFile="benh-do-virus.aspx.cs" Inherits="benh_do_rirus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="news-main">
            <div class="wrapper-news">
                        ...
                        <asp:ListView ID="lstNewHot" runat="server" DataSourceID="odsNewHot" EnableModelValidation="True">
                            <ItemTemplate>
                                <div class="news-image">
                                    <a href='<%# progressTitle(Eval("ProductName")) + "-vt-" + Eval("ProductID") + ".aspx" %>'>
                    ...
                    <div class="quangcao">
                        ...
                        <asp:ObjectDataSource ID="odsVideo" runat="server" SelectMethod="VideoSelectAll"
                            ...
                            <SelectParameters>
                                ...
                                <asp:Parameter Name="Description" Type="String" />
                                <asp:Parameter DefaultValue="2" Name="VideoCategoryID" Type="String" />
                                <asp:Parameter DefaultValue="True" Name="IsAvailable" Type="String" />
                                <asp:Parameter Name="Priority" Type="String" />
                                <asp:Parameter DefaultValue="True" Name="SortByPriority" Type="String" />
                            </SelectParameters>
                ...
                <div class="thumb-items">
                    <asp:ListView ID="lstBenhVirus" runat="server" DataSourceID="odsBenhVirus" EnableModelValidation="True">
                        <ItemTemplate>
                            <div class="item">
                                <div class="item-wrap">
                                    <div class="img">
                    ...
                    <asp:ObjectDataSource ID="odsBenhVirus" runat="server" SelectMethod="ProductSelectAll"
                        TypeName="TLLib.Product">
                        <SelectParameters>
        ...
        <div class="pager">
            <asp:DataPager ID="DataPager1" runat="server" PageSize="6" PagedControlID="lstBenhVirus">
                <Fields>
