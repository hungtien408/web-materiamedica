            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="VideoCategoryID" HeaderText="ID" 
                        SortExpression="VideoCategoryID" Visible="False">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn DataField="VideoCategoryNameEn" 
                        HeaderText="Tên danh mục(Tiếng Anh)" SortExpression="VideoCategoryName" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="IsShowOnMenu" HeaderText="Xem trên menu" 
                        SortExpression="IsShowOnMenu" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="IsShowOnHomePage" 
                        HeaderText="Xem trên trang chủ" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" 
                                ...
                                <img id="Img1" alt="" src='<%# "~/res/videocategory/" + Eval("ImageName") %>' width="80" runat="server"
                                    visible='<%# string.IsNullOrEmpty(Eval("ImageName").ToString()) ? false : true %>' />
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 240px x 137px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">
