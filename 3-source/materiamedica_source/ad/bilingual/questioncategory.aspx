<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="questioncategory.aspx.cs" Inherits="ad_single_productcategory" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="ProductCategoryName" HeaderText="Câu Hỏi">
                        <ItemTemplate>
                            <div class='<%#"catlevel level" +  Eval("Level") %>' style='padding-left: <%# string.IsNullOrEmpty(Eval("Level").ToString()) ? 0 : Convert.ToInt32(Eval("Level")) * 10 %>px'>
                                <asp:Label ID="lblProductCategoryName" runat="server" Font-Bold='<%# Eval("ParentID").ToString() == "0" ? true : false %>'
                                    Text='<%# Eval("ProductCategoryName")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <div class='<%#"catlevel level" +  Eval("Level") %>' style='padding-left: <%# string.IsNullOrEmpty(Eval("Level").ToString()) ? 0 : Convert.ToInt32(Eval("Level")) * 10 %>px'>
                                <asp:Label ID="lblProductCategoryNameEn" runat="server" Font-Bold='<%# Eval("ParentID").ToString() == "0" ? true : false %>'
                                    Text='<%# Eval("ProductCategoryNameEn")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn>
                        <ItemTemplate>
                            <div style="line-height: 10px; padding: 0 10px 0 10px;">
                                <asp:LinkButton ID="lnkUpOrder" runat="server" OnClick="lnkUpOrder_Click" rel='<%# Eval("ProductCategoryID") %>'>
                                    <img alt="" title="Lên 1 cấp" src="../assets/images/up-arrow.gif" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="lnkDownOrder" runat="server" OnClick="lnkDownOrder_Click" rel='<%# Eval("ProductCategoryID") %>'>
                    ...
                    <asp:GridTemplateColumn DataField="Level" HeaderText="Cấp độ" Visible="False">
                        <ItemTemplate>
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadComboBox ID="ddlParent" runat="server" DataSourceID='<%# (Container is GridEditFormInsertItem) ? "ObjectDataSource1" : "ObjectDataSource2" %>'
                                            DataTextField="ProductCategoryName" DataValueField="ProductCategoryID" Filter="Contains"
                                            OnDataBound="DropDownList_DataBound" Width="504px">
                                        </asp:RadComboBox>
                                        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ProductCategoryForEditSelectAll"
                                            TypeName="TLLib.ProductCategory">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="hdnProductCategoryID" Name="ProductCategoryID" PropertyName="Value"
                                                    Type="String" />
                                            </SelectParameters>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProductCategoryName" runat="server" Text='<%# (Container is GridEditFormInsertItem) ? "" : (string.IsNullOrEmpty(Eval("ProductCategoryName").ToString()) ? "" : Eval("ProductCategoryName").ToString().Remove(0, Convert.ToInt32(Eval("Level")))) %>'
                                            Width="500px" EmptyMessage="Câu hỏi...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
