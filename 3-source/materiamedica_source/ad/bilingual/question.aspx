<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="question.aspx.cs" Inherits="ad_single_product" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProductName" HeaderText="Trả Lời" SortExpression="ProductName" />
                    ...
                    <asp:GridTemplateColumn DataField="IsHot" HeaderText="Đúng" SortExpression="IsHot">
                        <ItemTemplate>
                                                ...
                                                <table class="search">
                                                    ...
                                                    <tr>
                                                        <td class="left" colspan="2">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkIsHot" runat="server" CssClass="checkbox" Text=" Đúng" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsHot").ToString()) ? false : Eval("IsHot"))%>' />
                                                            &nbsp;&nbsp;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProductName" runat="server" Text='<%# Bind("ProductName") %>'
                                                                Width="500px" EmptyMessage="Trả lời...">
                                                            </asp:RadTextBox>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter DefaultValue="6" ControlID="ddlSearchCategory" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
