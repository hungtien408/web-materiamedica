...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                        ...
                        <ItemTemplate>
                            <div style="position: relative">
                                ...
                                <div runat="server" visible='<%# string.IsNullOrEmpty(Eval("FileName").ToString()) ? false : (!Eval("FileName").ToString().ToLower().EndsWith(".swf") ? true : false) %>'>
                                    <img id="Img2" alt="" height="100" width="200" src='<%# "../../res/advertisement/" + Eval("FileName") %>' />
                                </div>
                                <div runat="server" visible='<%# Eval("FileName").ToString() == "" ? false : (Eval("FileName").ToString().ToLower().EndsWith(".swf") ? true : false) %>'>
                                    <object id="Object1" height="100" width="200" style="z-index: 0;" name="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1260px x 714px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        ...
                                        <asp:RadEditor ID="txtCompanyName" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                            runat="server" Height="200" Language="vi-VN" Skin="Office2007" Width="503px"
                                            Content='<%# Bind("CompanyName") %>'>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="AdsBannerDelete"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="5" Name="AdsCategoryID"
